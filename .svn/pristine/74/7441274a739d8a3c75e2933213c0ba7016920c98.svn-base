...
public class MenuActionImpl extends BaseActionImpl 
  implements IMenuAction {
	...
	/* (non-Javadoc)
	 * @see com.taikang.udp.sys.action.IMenuAction#updateMenuSubObject(com.taikang.udp.framework.common.datastructre.Dto)
	 */
	@Override
	public void updateMenuSubObject(Dto dto4) {
		// TODO Auto-generated method stub
		logger.debug("<======MenuAction--updateSubMenuObj======>");
		
		MenuBO menuBO = BaseDto.toModel(MenuBO.class , dto4);
		menuService.updateMenuSubObject(menuBO);
	}
