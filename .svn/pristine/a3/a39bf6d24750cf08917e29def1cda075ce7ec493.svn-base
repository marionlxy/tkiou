package com.taikang.tkcoww.orderVisit.service.impl;
 ...
 implements IOrderVisitService<OrderVisitBO>  
  {
	...
	public CurrentPage getOrderVisitList(CurrentPage page) {
		logger.debug("<======OrderVisitServiceImpl--getOrderVisitList======>");
		return appDao.queryForPage("OrderVisit.getOrderVisitList", page);
	}
 }
