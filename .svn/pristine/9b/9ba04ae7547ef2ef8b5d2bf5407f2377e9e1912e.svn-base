...
<title>500错误 - ${config.title}</title>
        ...
        <div class="errordex">
          ...
          <div class="errp">
            <div class="errpbox">
              ...
              <div class="errorimg"><img src="<c:url value="/resources/style/system/front/default/images/error/error500.jpg"/>" width="150" height="220" /></div>
