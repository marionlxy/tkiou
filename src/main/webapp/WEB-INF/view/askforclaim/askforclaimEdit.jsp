...
<div class="easyui-panel" title="XX详细信息编辑" style="width:600px">
	<form id="dataForm">
			<div class="fitem">
		        ...
		        <input name="meansName" class="easyui-textbox" data-options="required:true">
			</div>
			<div class="fitem">
		    	<label>meansMethod:</label>
		        <input name="meansMethod" class="easyui-textbox" data-options="required:true">
			</div>
			<div class="fitem">
		    	<label>meansEmail:</label>
		        <input name="meansEmail" class="easyui-textbox" data-options="required:true">
			</div>
			<div class="fitem">
		    	<label>meansBak:</label>
		        <input name="meansBak" class="easyui-textbox" data-options="required:true">
			</div>
			<div class="fitem">
...
jQuery(function(){ 
	...
	if (rowId != null && rowId != "" && rowId!=0){
		var url='${rootPath}/askforClaim/getOne?rowId=' + rowId;
