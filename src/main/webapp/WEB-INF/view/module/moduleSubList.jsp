...
<body>
	<div class="easyui-panel" title="${modName }" style="width: 805px">
		...
		<table id="dataTable" title="${modName }列表"
	...
	<script type="text/javascript">
		...
		//新增
		function addrow(modId,modIsleaf,modLevel,modName) {
			var title = '新增子栏目';
			...
			url = '/module/add?menuId=' + modId + '&modName='
					+ encodeURI(modName)+'&modLevel='+modLevel+'&modIsleaf='+modIsleaf;
			/* openWin(url); */
			window.parent.wrapper.addTab(title, url, '');
		}
		...
		function editrow() {
			...
			if (row) {
				url = '${rootPath}/module/edit?rowId=' + row.rowId;
				openWin(url);
			} else {
