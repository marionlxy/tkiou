	...
	<div style="padding: 10px 60px 20px 60px">
		<form id="dataForm" method="post">
				<div class="fitem">
		        	...
		        	<input name="contentId" class="easyui-textbox" >
		    	</div>
				<div class="fitem">
		        	<label>modId:</label>
		        	<input name="modId" class="easyui-textbox" >
		    	</div>
				<div class="fitem">
		        	<label>modNumber:</label>
		        	<input name="modNumber" class="easyui-textbox" >
		    	</div>
				<div class="fitem">
		        	<label>title:</label>
				...
				<div class="fitem">
		        	...
		        	<input name="contentImg" class="easyui-textbox" >
		    	</div>
				<div class="fitem">
		        	<label>contentImgBig:</label>
		        	<input name="contentImgBig" class="easyui-textbox" >
		    	</div>
				<div class="fitem">
		        	<label>hasBanner:</label>
		        	<input name="hasBanner" class="easyui-textbox" >
		    	</div>
				<div class="fitem">
		        	<label>bannerId:</label>
		        	<input name="bannerId" class="easyui-textbox" >
		    	</div>
				<div class="fitem">
		        	<label>content:</label>
				...
				<div class="fitem">
		        	...
		        	<input name="isDisplay" class="easyui-textbox" >
		    	</div>
				<div class="fitem">
		        	<label>weight:</label>
...
<script type="text/javascript">
	...
	jQuery(function(){	  
   	...
   	$('#dataTable').datagrid({
		...
		columns:[[
							{field:'contentId',title:'contentId',width:80},
							{field:'modId',title:'modId',width:80},
							{field:'modNumber',title:'modNumber',width:80},
							{field:'title',title:'title',width:80},
							{field:'contentImg',title:'contentImg',width:80},
							{field:'contentImgBig',title:'contentImgBig',width:80},
							{field:'hasBanner',title:'hasBanner',width:80},
							{field:'bannerId',title:'bannerId',width:80},
							{field:'content',title:'content',width:80},
							{field:'isDisplay',title:'isDisplay',width:80},
   ...
   //表格查询
	function searchInfo() {
		...
		var url = '${rootPath}/moduleContent/list';
   ...
   //新增
   function addrow(){
   		url = '${rootPath}/moduleContent/edit';
		openWin(url);
   }
   ...
   function editrow(){    	
       ...
       if (row){
       	url = '${rootPath}/moduleContent/edit?rowId='+ row.rowId;
		openWin(url);
       }
       else
       {
   ...
   function delerow(){
       ...
       if (row){
           $.messager.confirm('提示','确定要删除行记录吗？',function(r){
               if (r){
                   $.post('${rootPath}/moduleContent/del',{rowId:row.rowId},function(data){
