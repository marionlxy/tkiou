...
public class ModuleController extends BaseController {
	...
	@RequestMapping("/list")
	@ResponseBody
	public Map<String, Object> getSelctList(HttpServletRequest request,
			CurrentPage page) {
	...
	@RequestMapping(value="addFormSub")
	public  String  addFormSub(HttpServletRequest request,HttpServletResponse response,
			Model model) {
		...
		// 保存banner到服务器
		try {
			/*List<MultipartFile> files = multiRequest.getFiles("img");
			MultipartFile fmodBanner = files.get(0);*/
	...
	@ResponseBody
	public Map<String, String> deleteModule(@RequestParam("modId") String modId,@RequestParam("modLevel") String modLevel,@RequestParam("menuId") String menuId,@RequestParam("parentId") String parentId) {
		Map<String, String> map = new HashMap<String, String>();
		//注意顺序
		Dto param = new BaseDto();
