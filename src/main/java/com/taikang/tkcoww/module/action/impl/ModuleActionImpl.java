...
public class ModuleActionImpl extends BaseActionImpl implements IModuleAction {
	 ...
	 * 
	 * @see
	 * com.taikang.tkcoww.module.action.IModuleAction#findSubOneModule(com.taikang
	 * .udp.framework.common.datastructre.Dto)
	 */
	@Override
	 ...
	 * 
	 * @see
	 * com.taikang.tkcoww.module.action.IModuleAction#querySubMenu(com.taikang
	 ...
	 * 
	 * @see
	 * com.taikang.tkcoww.module.action.IModuleAction#updateSubObject(com.taikang
	 * .udp.framework.common.datastructre.Dto)
	 */
	@Override
	...
	public CurrentPage queryModuleList(CurrentPage page) {
		// TODO Auto-generated method stub
		logger.debug("<======ModuleAction--queryModuleList======>");
